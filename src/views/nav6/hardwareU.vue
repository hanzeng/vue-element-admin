    ...
    <div class="feedback">
        ...
        <el-row class="feedback-row">
            ...
            <el-col :span="24">
                ...
                <el-button>可借</el-button>
            </el-col>

            <el-col :span="24">
                <el-form inline>
                    <el-form-item>
                        <el-input placeholder="请输入雨伞编号"></el-input>
                    </el-form-item>
                    <el-form-item>
        ...
        <section>
            <el-table :data="tableData6" border style="width: 100%">
                ...
                <el-table-column prop="id" label="所在网点名称"></el-table-column>
                <el-table-column prop="amount1" label="使用次数"></el-table-column>
                <el-table-column prop="amount2" label="折损状况"></el-table-column>
